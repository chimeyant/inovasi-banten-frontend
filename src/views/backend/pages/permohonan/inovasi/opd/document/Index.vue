              ...
              <template v-slot:activator="{ on }">
                ...
                >
                  <v-icon
                    ...
                    @click="$router.push({name:'permohonan-inovasi-opd-indikator',params:{inovasi_uuid: $route.params.inovasi_uuid}})"
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl:
        "api/v2/permohonan/opd/inovasi-document/" +
        this.$route.params.inovasi_uuid +
        "/" +
        this.$route.params.indikator_uuid +
        "/" +
        this.$route.params.inovasi_indikator_uuid,
      pagination: false,
      key: "id",
      title: this.$route.params.indikator_name,
