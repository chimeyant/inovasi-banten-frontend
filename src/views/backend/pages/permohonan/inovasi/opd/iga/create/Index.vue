        ...
        <v-card class="animated animate__fadeIn rounded-0">
          ...
          <v-card-text>
            <v-row class="mt-5">
              ...
              <v-col cols=12>
                <v-textarea
                  label="Rancang Bangun dan Pokok Perubahan yang di lakukan"
                  outlined
                  dense
                  hide-details
                  :color="theme.color"
                  class="font-weight-thin"
                  rows="3"
                  v-model="record.rancang_bangun"
                  :filled="record.rancang_bangun"
                >
              ...
              <v-col cols=12>
                <v-textarea
                  ...
                  :filled="record.tujuan"
                >{{ record.tujuan }}</v-textarea>
              </v-col>
              <v-col cols=12>
                <v-textarea
                  ...
                  class="font-weight-thin"
                  rows="3"
                  v-model="record.manfaat"
                  :filled="record.manfaat"
                >{{ record.manfaat }}</v-textarea>
              </v-col>
              <v-col cols=12>
                <v-textarea
                  label="Hasil inovasi"
                  ...
                  class="font-weight-thin"
                  rows="3"
                  v-model="record.hasil"
                  :filled="record.hasil"
                >{{ record.hasil }}</v-textarea>
              </v-col>
              <v-row>
                <v-col cols="6">
                  <v-col cols="12">
                    <v-text-field
                      label="File Anggaran (PDF | Max: 2Mb)"
                      append-outer-icon="attachment"
                      class="font-weight-thin"
                      v-model="fileanggaran"
                      :filled="fileanggaran"
                      :color="theme.color"
                      outlined
                      dense
                ...
                <v-col cols="6">
                  <v-col cols="12">
                    <v-text-field
                      label="File Profil Bisnis (PDF | Max: 2Mb)"
                      class="font-weight-thin"
                      append-outer-icon="attachment"
                      v-model="fileprofilbisnis"
                      :filled="fileprofilbisnis"
                      :color="theme.color"
                      outlined
                      dense
              ...
              <v-col cols="12">
                <div class="title grey--text">Inovator dan Lokasi Inovasi</div>
              </v-col>
              <v-col cols="12">
                <v-row>
                  <v-col cols="8">
...
export default {
  ...
  created() {
    this.setPage({
      ...
      dataUrl: "api/",
      title: "PERMOHONAN",
      subtitle: "Formulir Permohonan IGA",
      breadcrumbs: [
        {
          text: "Permohonan",
          disabled: true,
