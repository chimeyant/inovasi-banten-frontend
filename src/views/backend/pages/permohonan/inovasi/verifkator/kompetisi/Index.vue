...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/v2/permohonan/verifikator/penilaian-kompetisi",
      pagination: false,
      key: "id",
      title: "DAFTAR PENILAIAN KOMPETISI",
      subtitle:
        "Berikut Daftar Seluruh Penilaian Permohonan Kompetisi Yang Tersedia",
      breadcrumbs: [
        {
          text: "Permohonan",
          disabled: true,
  ...
  methods: {
    ...
    openIndikatorPenilaian: function (val) {
      this.$router.push({
