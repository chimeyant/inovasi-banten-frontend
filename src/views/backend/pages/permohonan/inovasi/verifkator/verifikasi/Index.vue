      ...
      <v-col cols="12">
        <v-card class="animated animate__fadeInUp rounded-0">
          <v-card-title :class="`flex flex-row-reverse ` + theme.color + ` lighten-1`">
            ...
            >
              <template v-slot:activator="{ on }">
                ...
                >
                  <v-icon
                    :color="theme.mode == 'dark' ? `white` : `black`"
                    @click="$router.push({name:'permohonan-inovasi-verifikator'})"
            ...
            <v-spacer></v-spacer>
            <div class="font-weight-regular subtitle-1 white--text">Lembar Verifikasi</div>
            <v-icon
              small
                          ...
                          <v-row class="mt-5 mr-2 ml-2">
                            <v-col cols="12">
                              <v-textarea
                                label="Pesan | Catatan"
                                outlined
                                placeholder="Silahkan tulis pesan atau catatan yang akan disampaikan kepada pemohon inovasi...!"
                                dense
                                hide-details
                                :color="theme.color"
...
export default {
  ...
  created() {
    this.setPage({
      ...
      subtitle: "Lembar Formulir Verifikasi Permohonan",
      breadcrumbs: [
        {
          text: "Permohonan",
          disabled: true,
