      ...
      >
        <v-card>
          ...
          >
            ...
            >mdi-circle</v-icon> Formulir Klinik Konsultasi
          </v-toolbar>
          <v-card-text class="mt-2">
            ...
            <v-col col="12">
              <v-textarea
                ...
                :color="theme.color"
                hide-details
                label="Penjelasan/Pertanyaan/Permasalahan"
                placeholder=""
                v-model="record.body"
                :filled="record.body"
                dense
...
export default {
  ...
  created() {
    this.setPage({
      crud: true,
      dataUrl: "api/v2/permohonan/message",
      pagination: false,
      key: "id",
      title: "KLINIK KONSULTASI",
      subtitle: "Berikut Daftar Seluruh Konsultasi Yang Tersedia",
      breadcrumbs: [
        {
          text: "Permohonan",
          disabled: true,
